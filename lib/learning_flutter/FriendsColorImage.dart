...
class _friendsState extends State<friends> {
  Map Friends={
    'Vrishti': ['Purple', Colors.purple, Image.asset('../Vrishti.png')],
    'Amanjot': ['Blue', Colors.blue, Image.asset('../Vrishti.png')],
    'Mehak' : ['Red', Colors.red, Image.asset('../Amanjot.png')],
    'Neha' : ['Green', Colors.green, Image.asset('../Vrishti.png')]
  };
